      ...
      <main className="pt-24 pb-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose max-w-none dark:prose-invert">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">5. Service Availability</h2>
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                <br />
                <a href="mailto:legal@apobasi.com" className="text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300">
                  legal@apobasi.com
                </a>
              </p>
            </section>
