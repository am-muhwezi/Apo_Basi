  ...
  return (
    <div className="min-h-screen bg-gray-950">
      ...
      <main className="pt-16">
        {/* Hero Section */}
        <section className="relative min-h-screen flex items-center bg-gradient-to-b from-gray-950 to-gray-900 overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="animate-fade-in">
                ...
                <div className="flex gap-8 mt-10 pt-10 border-t border-gray-800">
                  <div>
                    <p className="text-2xl font-bold text-white">For Schools</p>
                    <p className="text-gray-400 text-sm">Simple tools for admins to manage transport</p>
                  </div>
                  <div>
                    <p className="text-2xl font-bold text-white">For Families</p>
                    <p className="text-gray-400 text-sm">Live tracking and instant notifications</p>
                  </div>
                </div>
              </div>
                ...
                <Card variant="gradient" className="shadow-2xl">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    ...
                    <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700/50">
                      ...
                      <p className="text-2xl font-bold text-white">640</p>
                    </div>
                    <div className="bg-gray-800/50 rounded-xl p-4 border border-gray-700/50">
              ...
              <div>
                ...
                <div className="space-y-4">
                  {howItWorks.schools.map((item) => (
                    <div key={item.step} className="flex gap-4 p-4 rounded-xl bg-gray-800/50 border border-gray-700/50">
              ...
              {testimonials.map((testimonial) => (
                <Card key={testimonial.author} variant="glass" className="flex flex-col">
                  <div className="flex-1">
                    ...
                    <p className="text-gray-200 leading-relaxed mb-6">{testimonial.quote}</p>
                  </div>
                ...
                <div className="space-y-4 mb-8">
                  <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-800/50 border border-gray-700/50">
                    ...
                    <div>
                      ...
                      <a href="mailto:hello@apobasi.com" className="text-white font-medium hover:text-blue-400 transition-colors">
                        hello@apobasi.com
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 rounded-xl bg-gray-800/50 border border-gray-700/50">
                    ...
                    <div>
                      <p className="text-gray-400 text-sm">Serving schools in</p>
                      <p className="text-white font-medium">Uganda, Kenya & East Africa</p>
                    </div>
                  </div>
                </div>
                ...
                <form className="space-y-6" action="https://formspree.io/f/your-form-id" method="POST">
                  <div>
                    ...
                    <input
                      ...
                      name="name"
                      required
                      className="w-full px-4 py-3 rounded-xl bg-gray-800 border border-gray-700 text-white placeholder-gray-500 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors"
                  ...
                  <div>
                    <label htmlFor="school" className="block text-sm font-medium text-gray-300 mb-2">School Name</label>
                    <input
                      type="text"
                      id="school"
                      name="school"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={4}
                      required
                      className="w-full px-4 py-3 rounded-xl bg-gray-800 border border-gray-700 text-white placeholder-gray-500 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-colors resize-none"
