...
export default function Navbar() {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 glass backdrop-blur-sm bg-gray-900/90">
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            ...
            <span className="font-bold text-lg text-white tracking-tight">ApoBasi</span>
          </Link>
            ...
            <div className="flex flex-col gap-2 pt-4 border-t border-gray-800">
              ...
              <div className="flex flex-col gap-2 mt-4 px-4">
                <Link
                  to="/login"
                  onClick={closeMobileMenu}
                  className="py-2 text-center text-sm font-medium text-gray-300 border border-gray-700 rounded-full"
                >
                  Admin Sign In
                </Link>
                <a
