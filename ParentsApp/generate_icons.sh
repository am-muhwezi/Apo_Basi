...
# Generate app icons from SVG source for all platforms
...
echo "  • macOS (7 sizes)"
echo ""
echo "Note: For Windows .ico file, you may need additional tools."
echo "      The PNG icons are ready for all other platforms."
